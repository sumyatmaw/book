...
$pending_payments_query = mysqli_query($conn, "SELECT COUNT(*) as total FROM Payment WHERE status = 'pending'");
$pending_payments_count = mysqli_fetch_assoc($pending_payments_query)['total'] ?? 0;
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <header class="h-16 bg-white border-b border-slate-200/80 flex items-center justify-between px-4 md:px-8 z-40 shrink-0">
            ...
            <div class="flex items-center space-x-4 relative">
                ...
                <div class="relative">
                    ...
                    <div id="notiDropdown" class="hidden absolute right-0 top-12 w-80 bg-white border border-slate-200 shadow-xl rounded-2xl overflow-hidden z-50">
                        ...
                        <div class="p-4 text-center text-xs text-slate-400 font-medium">
                            <?php echo ($low_stock_count + $pending_payments_count > 0) ? "You have system alerts pending." : "No new operational notifications."; ?>
                        </div>
                    </div>
                </div>
                
                <!-- Admin Profile Menu Button (Dashboard Style) -->
                <div class="relative border-l border-slate-200 pl-4">
                    ...
                    <!-- Admin Profile Dropdown Menu with 3 requested links -->
